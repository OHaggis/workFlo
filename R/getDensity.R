#' Gets the density of a point within a raster (plot area)
#'
...
#' @param n specifies how many intersections the grid for calculation of the density should have. Defaults to n = 50 (50 x 50 raster).
#' @importFrom MASS kde2d
#' @return a column of numerical density values
#' @export
#' @examples
#' library(ggplot2)
#' library(dplyr)
